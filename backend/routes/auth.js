...
router.get('/me', protect, async (req, res) => {
  try {
    const user = await User.findById(req.user.id)
      ...
      .populate('purchaseHistory.product', 'name category aesthetic');
...
// @desc    Test endpoint for server connectivity
// @route   GET /api/auth/test
// @access  Public
router.get('/test', (req, res) => {
  res.status(200).json({
    success: true,
    message: 'Server is running and authentication routes are working',
